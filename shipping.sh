...
# #Validate function takes input as exit code and what command they try to install
# VALIDATE(){
#     if [ $1 -eq 0 ]
#     then
#         echo -e "$2 is .. $G SUCCESS $R" | tee -a $LOG_FILE
#     else
#         echo -e "$2 is .. $R FAILURE $N" | tee -a $LOG_FILE
#         exit 1
#     fi
...
# mvn clean package &>>$LOG_FILE
# VALIDATE $? "Packaging the shipping app"
